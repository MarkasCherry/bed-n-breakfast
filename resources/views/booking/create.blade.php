    ...
    <div id="huro-app" class="app-wrapper">
        ...
        <form method="POST" action="{{ route('bookings.store') }}">
            ...
            <div id="activity-panel" class="right-panel-wrapper is-activity">
                <!-- Content Wrapper -->
                <div id="app-search" class="view-wrapper is-webapp" data-naver-offset="214"
                     data-page-title="SaaS Billing"
                    ...
                    <div class="page-content-wrapper">
                        <div class="page-content is-relative">
                            <div class="page-content-inner">
                                ...
                                <div class="saas-billing-wrapper m-t-100">
                                    <div class="billing-options-wrapper">
                                        <div class="left">
                                            <div class="option-block">
                                                ...
                                                <div class="block-body">
                                                    <p>{{ __('To stay with us from ') }}<strong>{{ $checkIn }}</strong>
                                                        {{ __('to') }} <strong>{{ $checkOut }}</strong>.</p>
                                                    <p>{{ __('In') }}
                                                        <strong>{{ $room->property->name }}</strong> {{ __('apartment') }}
                                                        .</p>
                                                    <p>{{ __('Room') }}: <strong>{{ $room->name }}
                                                            ({{ $room->room_number }}).</strong>
                                                    </p>
                                                    <p>{{ __('For') }} <strong>{{ $guestsNo }} {{ __('pers') }}
                                                            .</strong></p>
                                                    @if($breakfast)
                                                        <p>
                                                    ...
                                                    @endif
                                                    <br>
                                                    <p>{{ __('If you would like to make some changes press') }}
                                                        <a href="{{ route('rooms.show', $room->id) }}">{{ __('here') }}
                                                            .</a>
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="down">
                                                <div class="option-block">
                                                    ...
                                                    <div class="block-body">
                                                        <p>{{ __('Price for ') . $daysBooked .  __(' days is ')}}
                                                            <strong>
                                                                ¥{{ $daysBooked * $room->night_price }}
                                                            </strong></p>
                                                        <x-inputs.switcher for="deposit" name="deposit">
                                                            <x-slot
                                                                name="title">{{ __('Select if you want to pay just deposit (') . App\Tools::displayPrice($daysBooked * $room->night_price * $depositSize) .')' }}</x-slot>
                                                        </x-inputs.switcher>
                                                    </div>

                                                    <h1 class="title is-5 is-narrow m-t-30">Your payment: <span
                                                            class="text-info" id="payment-price">{{ App\Tools::displayPrice($daysBooked * $room->night_price) }}</span></h1>
                                                </div>
                                            </div>
                                            @if (count($errors) > 0)
                                                <div class="down">
                                        ...
                                        <input type="hidden" name="booked_from" value="{{ $checkIn }}">
                                        <input type="hidden" name="booked_to" value="{{ $checkOut }}">
                                        <input type="hidden" name="room" value="{{ $room->id }}">
                                        <input type="hidden" name="guestsNo" value="{{ $guestsNo }}">
                                        <input type="hidden" name="breakfast" value="{{ $breakfast }}">
                                        <input type="hidden" name="days_booked" value="{{ $daysBooked }}">
                                        <div class="right">
                                            <div class="payment-form">
                                                <div class="form-header">
                                                    <h3>Payment information</h3>
                                                    <span style="display: none" id="generatecard">Randomize</span>
                                                </div>
                                                    ...
                                                    <div class="creditcard">
                                                        ...
                                                        <g id="Front2">
                                                            ...
                                                            <text transform="matrix(1 0 0 1 60.106 295.0121)"
                                                                  id="svgnumber" class="st2 st3 st4">0123 4567 8910
                                                                1112
                                                            </text>
                                                            <text transform="matrix(1 0 0 1 54.1064 428.1723)"
                                                                  id="svgname" class="st2 st5 st6">JOHN DOE
                                                            </text>
                                                            ...
                                                            <g>
                                                                <text transform="matrix(1 0 0 1 574.4219 433.8095)"
                                                                      id="svgexpire" class="st2 st5 st9">01/23
                                                                </text>
                                                    ...
                                                    <div class="columns is-multiline">
                                                        ...
                                                        <div class="column is-12">
                                                            <div class="field">
                                                                ...
                                                                <div class="control">
                                                                    <input name="card_number" id="cardnumber"
                                                                           class="input" type="text"
                                                                           placeholder="Credit card number">
                                                                    <svg id="ccicon" class="ccicon" width="750"
                                                                         height="471" viewBox="0 0 750 471"
                                                                         version="1.1"
                                                                         xmlns="http://www.w3.org/2000/svg"
                                                        ...
                                                        <div class="column is-6">
                                                            <div class="field">
                                                                ...
                                                                <div class="control">
                                                                    <input name="expiration_date" id="expirationdate"
                                                                           class="input" type="text"
                                                                           placeholder="MM / YY">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="column is-6">
                                                            <div class="field">
                                                                ...
                                                                <div class="control">
                                                                    <input name="security_code" id="securitycode"
                                                                           class="input" type="text" pattern="[0-9]*"
...
@push('scripts')
    <script src="{{ asset('assets/js/saas-billing.js') }}"></script>
    <script src="{{ asset('assets/js/syntax.js') }}"></script>
    <script>
        document.getElementById('deposit').addEventListener('click', function(){
            if(this.checked){
                document.getElementById('payment-price').innerHTML = "{{ App\Tools::displayPrice($daysBooked * $room->night_price * $depositSize) }}";
            }
            else{
                document.getElementById('payment-price').innerHTML = "{{ App\Tools::displayPrice($daysBooked * $room->night_price) }}";
            }
        });
    </script>
@endpush
